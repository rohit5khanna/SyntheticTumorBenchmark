...
| The SRD-SAILOR domain gap is scientifically useful | Moderate-to-strong framing claim | Domain-gap analysis quantifies what controlled SRD omits and what real SAILOR adds | Reviewers may read mismatch as generator weakness unless the role distinction is explicit | Put the role distinction early: SRD = controlled mechanism isolation; SAILOR = real transition complexity |
...
| Boundary proximity is a strong growth-front prior | Strong descriptive prior | Distance baseline and delayed-hit analyses on SRD/SAILOR; biological plausibility | Some SAILOR growth is non-boundary/distant; radius choice affects magnitude | Report as a strong but incomplete prior, not a sufficient forecaster |
