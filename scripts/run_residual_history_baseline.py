...
from baselines.residual_unet import run_residual_unet_baseline


def main() -> None:
    parser = argparse.ArgumentParser(description="Run residual-history UNet baseline.")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/residual_baselines")
    args = parser.parse_args()

    summary = run_residual_unet_baseline(
